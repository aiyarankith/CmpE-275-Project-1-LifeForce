...
/** 
 * Partial sharding and replication of meta data(reference where the data is located) 
 */
public class MetaDataManager {
	...
	private String host = "192.168.0.7";//10.0.0.7";
	private int port = 3000;
	
	//Primary MD-Node details
	private String host1 = "192.168.0.7";//10.0.0.7";
	private int port1 = 3000;
	
	//Secondary/replica MetaDataNode details.
	private String host2 = "192.168.0.9";//10.0.0.7";
